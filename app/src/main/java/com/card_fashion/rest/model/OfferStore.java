package com.card_fashion.rest.model;
...
public class OfferStore implements Parcelable {
    ...
    public OfferStore(Flag flag, Cover cover, String name, String id, String name_local, String phone_number, String address, String maps_url, String website_link, String area, ArrayList<Location> locationsArrayL) {
        this.flag = flag;
        this.cover = cover;
        this.name = name;
        this.id = id;
    ...
    protected OfferStore(Parcel in) {
    ...
    public static final Creator<OfferStore> CREATOR = new Creator<OfferStore>() {
        @Override
        public OfferStore createFromParcel(Parcel in) {
            return new OfferStore(in);
        }

        @Override
        public OfferStore[] newArray(int size) {
            return new OfferStore[size];
        }
    };
