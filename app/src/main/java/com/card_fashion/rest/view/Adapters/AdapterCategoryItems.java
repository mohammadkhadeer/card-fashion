...
//    List<Offer> mList = new ArrayList<>();
    ...
    public AdapterCategoryItems.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType)
    {
        View view = LayoutInflater.from(viewGroup.getContext()).
                inflate(R.layout.adapter_category_items, viewGroup, false);
