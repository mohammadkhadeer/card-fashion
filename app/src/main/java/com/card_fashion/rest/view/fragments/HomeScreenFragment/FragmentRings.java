...
public class FragmentRings extends Fragment implements AdapterSet.PassItem{
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_rings, container, false);
        inti();
        changeFont();
    ...
    private void actionListenerToSeeAll() {
        relativeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString("category",getActivity().getResources().getString(R.string.rings_s));
