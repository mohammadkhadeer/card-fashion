package com.card_fashion.rest.view.fragments;
...
import com.card_fashion.rest.model.Flag;
import com.card_fashion.rest.presnter.JsonPlaceHolderApi;
import com.card_fashion.rest.view.Adapters.AdapterCountries;
import com.card_fashion.rest.view.activity.Login;
    ...
    private void timer() {
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                {
                    Intent intent = new Intent(getActivity(), com.card_fashion.rest.view.activity.Language.class);
