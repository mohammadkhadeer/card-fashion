...
import com.card_fashion.rest.database.DBHelper;
import com.card_fashion.rest.model.Areas;
import com.card_fashion.rest.model.City;
import com.card_fashion.rest.model.Countries;
import com.card_fashion.rest.presnter.JsonPlaceHolderApi;
import com.card_fashion.rest.view.activity.mainScreem.MainActivity;
...
import static com.card_fashion.rest.apiURL.API.apiURLBase;
import static com.card_fashion.rest.functions.Functions.getTimeStamp;
import static com.card_fashion.rest.functions.RetrofitFunctions.getAreasApi;
import static com.card_fashion.rest.functions.RetrofitFunctions.getCitiesApi;
import static com.card_fashion.rest.functions.RetrofitFunctions.getCountries;
import static com.card_fashion.rest.functions.RetrofitFunctions.getNumberOfCountries;
import static com.card_fashion.rest.sharedPreferences.Country.getCountryFromSP;
import static com.card_fashion.rest.sharedPreferences.Country.saveCountryInSP;
import static com.card_fashion.rest.sharedPreferences.Language.getLanguageFromSP;
import static com.card_fashion.rest.sharedPreferences.LoginInfo.getLoginOrNotFromSP;
import static com.card_fashion.rest.sharedPreferences.NumberOfNotification.getNumberOfItemInCartFromSP;
import static com.card_fashion.rest.sharedPreferences.NumberOfNotification.saveNumberOfItemsInCartInSP;
    ...
    private void timer() {
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                {
                    Intent intent = new Intent(SplashScreen.this, com.card_fashion.rest.view.activity.Language.class);
