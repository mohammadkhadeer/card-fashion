...
public class AdapterSet extends RecyclerView.Adapter<AdapterSet.ViewHolder>{
...
//    List<Offer> mList = new ArrayList<>();
    ...
    public AdapterSet.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType)
    {
        View view = LayoutInflater.from(viewGroup.getContext()).
                inflate(R.layout.adapter_set, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final AdapterSet.ViewHolder holder, final int position) {
