...
import com.card_fashion.rest.view.Adapters.AdapterSet;
import com.card_fashion.rest.view.activity.CategoryItem;

import java.util.ArrayList;

public class FragmentBracelets extends Fragment implements AdapterSet.PassItem{
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_bracelets, container, false);
        inti();
        changeFont();
    ...
    private void actionListenerToSeeAll() {
        relativeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString("category",getActivity().getResources().getString(R.string.bracelets_s));
